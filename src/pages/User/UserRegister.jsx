...
const UpdateUser = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        setAlert({ type: "danger", message: error.response?.data?.message || "Failed to fetch user details." });
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setAlert({ type: "danger", message: error.response?.data?.message || "Failed to update user." });
    }
  };
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="mt-5 pt-3 col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <Breadcrumbs title="Update User" breadcrumbs={[{ label: "Home", path: "/dashboard" }, { label: "Users", path: "/users" }, { label: "Update User", path: location.pathname, active: true }]} />
          </div>
              ...
              <div className="col-md-6">
                <div className="card card-primary card-outline mb-4">
                  ...
                  <div className="card-body">
                    {alert.message && <div className={`alert alert-${alert.type}`} role="alert">{alert.message}</div>}
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className="card-footer d-flex justify-content-center mt-2">
                        <button type="submit" className="btn btn-primary col-sm-12 mt-3" disabled={submit}>Submit</button>
                      </div>
                    </form>
                  </div>
                </div>
